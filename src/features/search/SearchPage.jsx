...
export default function SearchPage() {
  ...
  const [activeTab, setActiveTab] = useState("soal"); // "soal" | "topik"
  ...
  const totalTopik =
    (results.topik?.length || 0) + (results.jenjang?.length || 0);
  const isEmpty =
    hasSearched &&
    !loading &&
    ...
    activeTab === "soal";
  const isEmptyTopik =
    hasSearched && !loading && totalTopik === 0 && activeTab === "topik";
      ...
      >
                        ...
                        {jenjangList.map((j) => (
                          <button
                            ...
                            style={{
                              ...
                              borderRadius: "7px",
                              border: `1.5px solid ${
                                filterJenjang === j.slug ? "#e84c2b" : "#e2ddd5"
                              }`,
                              background:
                                filterJenjang === j.slug ? "#fff3f0" : "white",
                              color:
                                filterJenjang === j.slug
                                  ? "#e84c2b"
                                  : "#6b6860",
                              fontSize: "12px",
                              fontWeight: "600",
                      ...
                      >
                        <button
                          ...
                          style={{
                            ...
                            borderRadius: "7px",
                            border: `1.5px solid ${
                              !filterDifficulty ? "#e84c2b" : "#e2ddd5"
                            }`,
                            background: !filterDifficulty ? "#fff3f0" : "white",
                            color: !filterDifficulty ? "#e84c2b" : "#6b6860",
                            fontSize: "12px",
                            fontWeight: "600",
                            cursor: "pointer",
                            fontFamily: "inherit",
                        ...
                        {DIFFICULTY_OPTIONS.map((d) => (
                          <button
                            ...
                            onClick={() =>
                              setFilterDifficulty(
                                filterDifficulty === d.value ? "" : d.value
                              )
                            }
                            style={{
                              padding: "5px 12px",
                              ...
                              background:
                                filterDifficulty === d.value ? d.bg : "white",
                              color:
                                filterDifficulty === d.value
                                  ? d.color
                                  : "#6b6860",
                      ...
                      >
                        <button
                          ...
                          style={{
                            ...
                            borderRadius: "7px",
                            border: `1.5px solid ${
                              !filterTipe ? "#e84c2b" : "#e2ddd5"
                            }`,
                            background: !filterTipe ? "#fff3f0" : "white",
                            color: !filterTipe ? "#e84c2b" : "#6b6860",
                            fontSize: "12px",
                            fontWeight: "600",
                            cursor: "pointer",
                            fontFamily: "inherit",
                        ...
                        {TIPE_OPTIONS.map((t) => (
                          <button
                            ...
                            style={{
                              ...
                              borderRadius: "7px",
                              border: `1.5px solid ${
                                filterTipe === t.value ? "#e84c2b" : "#e2ddd5"
                              }`,
                              background:
                                filterTipe === t.value ? "#fff3f0" : "white",
                              color:
                                filterTipe === t.value ? "#e84c2b" : "#6b6860",
                              fontSize: "12px",
                              fontWeight: "600",
                              cursor: "pointer",
                              fontFamily: "inherit",
          ...
          >
            <button
              ...
              style={{
                ...
                borderRadius: "9px",
                border: "none",
                background: activeTab === "soal" ? "white" : "transparent",
                color: activeTab === "soal" ? "#0f0e17" : "#6b6860",
                fontSize: "13px",
                fontWeight: "600",
                cursor: "pointer",
                fontFamily: "inherit",
                transition: "all .15s",
                boxShadow:
                  activeTab === "soal" ? "0 1px 4px rgba(0,0,0,0.08)" : "none",
              }}
            >
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "9px",
                border: "none",
                background: activeTab === "topik" ? "white" : "transparent",
                color: activeTab === "topik" ? "#0f0e17" : "#6b6860",
                fontSize: "13px",
                fontWeight: "600",
                cursor: "pointer",
                fontFamily: "inherit",
                transition: "all .15s",
                boxShadow:
                  activeTab === "topik" ? "0 1px 4px rgba(0,0,0,0.08)" : "none",
              }}
            >
        ...
        {activeTab === "soal" && activeFilterCount > 0 && (
          ...
          >
            {filterJenjang && (
              <div
                style={{
                  ...
                  borderRadius: "7px",
                  background: "#fff3f0",
                  border: "1px solid #e84c2b",
                  fontSize: "12px",
                  fontWeight: "600",
                  color: "#e84c2b",
                }}
              >
                {jenjangList.find((j) => j.slug === filterJenjang)?.nama ||
                  filterJenjang}
                <button
                  onClick={() => setFilterJenjang("")}
                  style={{
            ...
            {filterDifficulty &&
              (() => {
                const d = DIFFICULTY_OPTIONS.find(
                  (d) => d.value === filterDifficulty
                );
                return (
                  <div
                    style={{
          ...
          <>
            {isEmpty && (
              ...
              >
                ...
                >
                  Tidak ada soal untuk "{query}"
                  {activeFilterCount > 0 && " dengan filter ini"}
                </p>
                {activeFilterCount > 0 ? (
                  <button
                  ...
                  >
                    {loading
                      ...
                      : `Tampilkan lebih banyak (${
                          results.total - results.soal.length
                        } tersisa)`}
                  </button>
                )}
              </div>
            ...
            >
              ...
              {results.topik.length > 0 && (
                <div>
                  ...
                  >
                    <FolderTree size={13} /> Topik & Subtopik (
                    {results.topik.length})
                  </div>
                  <div
                    style={{
                      display: "flex",
                    ...
                    {results.topik.map((t, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            <FolderTree size={14} color="#6b6860" />
                          </div>
